		...
		<div class="container">
			...
			<div id="loginBox" class="features-info" style="text-align: center;">
				...
				<form id="loginForm"
					style="margin: auto;">
					<div>
						<input type="email" class="text" name="inputUsername" id="inputUsername"
							placeholder="Username" required />
					</div>
					<div>
						<input type="password" name="inputPassword" id="inputPassword" placeholder="Password" required />
					</div>
					<button type="submit" onclick="return verifyLogin();"
								class="btn btn-info btn-block">Login</button><br /> <span><a
						href="#">Sign Up</a></span>
				</form>
