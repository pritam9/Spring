                                         ...
                                         <div class="panel panel-primary">
                                             ...
                                             <div class="panel-body">
												...
												<a href="" class="btn btn-info" data-ng-click="addQuestions(quiz.quizId)" role="button">Add Questions</a>
                                                 ...
                                                 <p>
                                                 <a href="" class="btn btn-success pull-left col-xs-12" data-ng-click="scorecard(quiz.quizId)" role="button">View Scores</a>
                                                 <a href="" class="btn btn-info center col-xs-12" data-ng-click="addQuestions(quiz.quizId)" role="button">Add Questions</a>
                                                 <a href="" class="btn btn-warning pull-right col-xs-12" data-ng-show="quiz.locked" data-ng-click="unlock(quiz.quizId)" role="button">Unlock Quiz!</a> 
                                                 <a href="" data-ng-hide="quiz.locked" class="btn btn-danger pull-right col-xs-12" data-ng-click="lock(quiz.quizId)" role="button">Lock Quiz</a></p>
