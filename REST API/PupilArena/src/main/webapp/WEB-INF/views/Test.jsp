...
<head>
    ...
    <script type="text/javascript" src="resources/js/angular/userHome.js"></script>
...
<div class="wrapper">
    ...
    <div class="main-panel" data-ng-controller="toggleBar">
        <nav class="navbar navbar-default navbar-fixed">
            <div class="container">
            	<div class="navbar-header">
                    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target="#navigation-example-2" data-ng-click="isMobile=!isMobile">
