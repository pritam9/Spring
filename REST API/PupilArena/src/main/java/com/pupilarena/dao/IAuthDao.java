...
public interface IAuthDao {
	...
	boolean sendRequest(int groupId, String sender_email_id, String studentId, String status, boolean isSenderLeader);
	...
	boolean checkIfUserParticipated(int quizId, String emailId);
