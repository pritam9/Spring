...
<%  
		ArrayList<Question> survey1 = (ArrayList<Question>) request.getAttribute("survey1");
		ArrayList<Question> survey2 = (ArrayList<Question>) request.getAttribute("survey2");
		ArrayList<Question> survey3 = (ArrayList<Question>) request.getAttribute("survey3");
		ArrayList<Question> survey4 = (ArrayList<Question>) request.getAttribute("survey4");
		ArrayList<Question> survey5 = (ArrayList<Question>) request.getAttribute("survey5");
		ArrayList<Question> survey6 = (ArrayList<Question>) request.getAttribute("survey6");
		ArrayList<Question> survey7 = (ArrayList<Question>) request.getAttribute("survey7");
		ArrayList<Question> survey8 = (ArrayList<Question>) request.getAttribute("survey8");
...
<body style="padding: 10px">
    ...
    <div class="col-xs-offset-1 col-xs-10 col-xs-offset-1"><div class="Center"><h1><%= user.getFirstName()%>'s Personalized Feedback</h1></div>  </div>
        ...
        <br><br><div class="col-xs-offset-0.5 col-xs-11 col-xs-offset-0.5"><h4>SmarTrek is designed to assist you in examining your drinking and marijuana use in a safe and accepting environment. Your responses to the survey and this feedback report are confidential and are available only to you and your MI Coach.</h4></div>
		<br><br>   
		...
		<br><br>
		<div class="col-xs-offset-0.5 col-xs-11 col-xs-offset-0.5">
		<canvas id="freqDrinkingChart" width="400" height="400"></canvas>
            </div>
		...
		<br><br>
            <div class="col-xs-offset-0.5 col-xs-11 col-xs-offset-0.5">
		<canvas id="quantityDrinkingChart" width="400" height="400"></canvas>
            </div>
	...
	<th>Agree</th>
	<% for(SubQuestion sq : pf.cea1.getSubquestions()) {%>
	<tr>
	<%
	String color1 = "white";
	String color2 = "white";
	...
	<th>Slightly Good</th>
	<th>Good</th>
	<% for(SubQuestion sq : pf.cea2.getSubquestions()) {%>
	<tr>
	<%
	String color1 = "white";
	String color2 = "white";
	...
	<h5><%= user.getFirstName()%>, according to the information you provided in the SmarTrek Surveys about your typical quantity of alcohol use, hours of use, your birth sex, and your weight, your peak and typical BAC during the last 30 days were calculated.</h5>
	<br><br>
	...
	<div style="padding: 10px; background: black; color: white; display: inline-block;" id="BACCHART">
		<div><h4><%= pf.genderString%> <%= pf.weight%> lbs <span style="color: orange; font-size: 30px">Blood Alcohol Concentration</span></h4></div>
	...
	<br><br>
		<canvas id="bacChangesChart" width="400" height="400"></canvas>
		</div>
	<br><br>
	...
	<canvas id="alcoholNutritionChart" width="250" height="250"></canvas>
	</div >
	<div style="margin-left: 265px; text-align: center; width: 250px;">
	<h4>250 Calories per Drink</h4>
	<canvas id="alcoholNutritionChart2" width="250" height="250"></canvas>
	</div>
	<br><br>
	...
	<table border="1">
		...
		<tr>
			...
			<td>
				<ul>
					<% if(pf.byaacq != null) {
					      for(SubQuestion sq : pf.byaacq.getSubquestions()) {
	...
	<br><h5>In the SmarTrek Survey, you completed the AUDIT screening test which estimated your risk for alcohol-related problems.</h5>
	<br><br>
	...
	<tr>
	<td colspan="10">On the SmarTrek survey, you indicated how important it was for you to make a change in your drinking.
	...
	<tr>
	<td colspan="10">On the SmarTrek survey, you indicated how confident you were than you could make a change in your drinking.
