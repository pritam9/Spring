...
<%@page import="java.util.Collections" %>
        ...
        <form role="form">
            ...
            <div class="form-group" id="parent102">
            <label style="font-size: 22px;margin-top: 10px;">Alcohol-Related Consequences</label>
            </div>
            ...
            <tr>
            <td class="TableBorder">
            <label for="227">I have felt like I needed a drink after I’d gotten up (that is, before breakfast).</label>

            <td class="TableBorder Center"> <input type="radio" name="sub227" id=opt"265" value="0" />

            <td class="TableBorder Center"> <input type="radio" name="sub227" id=opt"266" value="1" />

            <td class="TableBorder Center"> <input type="radio" name="sub227" id=opt"267" value="2" />

            <td class="TableBorder Center"> <input type="radio" name="sub227" id=opt"268" value="3" />
			<% } %>
